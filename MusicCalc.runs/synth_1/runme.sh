...
HD_PWD='F:/VivadoProject/MusicCalc/MusicCalc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MusicCalc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MusicCalc.tcl
