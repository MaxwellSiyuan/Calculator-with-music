...
HD_PWD='F:/VivadoProject/MusicCalc/MusicCalc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MusicCalc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MusicCalc.tcl -notrace
